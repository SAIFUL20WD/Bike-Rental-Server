...
const initiatePayment = (paymentData, urlPart) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield axios_1.default.post(process.env.PAYMENT_URL, {
            store_id: process.env.STORE_ID,
            signature_key: process.env.SIGNETURE_KEY,
            tran_id: paymentData.transactionId,
            success_url: `${process.env.SERVER_URL}/api/payments/${urlPart}/confirmation?transactionId=${paymentData.transactionId}&status=success`,
            fail_url: `${process.env.SERVER_URL}/api/payments/${urlPart}/confirmation?status=failed`,
