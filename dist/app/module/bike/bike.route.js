...
router.get("/brands", bike_controller_1.BikeControllers.getAllBrands);
router.get("/models", bike_controller_1.BikeControllers.getAllModels);
router.get("/get-bike-by-tag", bike_controller_1.BikeControllers.getBikesByTag);
router.get("/:id", bike_controller_1.BikeControllers.getBikeById);
